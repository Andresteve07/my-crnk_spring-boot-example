...
import com.example.helloworldproj.domain.repository.ProjectRepository;
...
public class SpringBootSimpleExampleApplicationTests extends BaseTest {
    ...
    public void testClient() {
        ...
        ProjectRepository.ProjectList list = projectRepo.findAll(querySpec);
        Assert.assertNotEquals(0, list.size());

        // test meta access
        ProjectRepository.ProjectListMeta meta = list.getMeta();
        Assert.assertEquals(4L, meta.getTotalResourceCount().longValue());

        // test pagination links access
        ProjectRepository.ProjectListLinks links = list.getLinks();
